...
// this style never gets re-generated on every render by Js 
...
export default function StarRating({ maxRating = 5, color = "#fcc419", size = 48, messages = [], clasName = "", defaultRating = 0, onSetRating }) {
